...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _checkBiometrics() async {
    try {
      ...
      if (mounted) setState(() => _biometricsAvailable = !kIsWeb && canCheck && isSupported);
    } catch (e) {
      ...
      if (_isSignIn) {
        ...
        if (response.user != null) {
          ...
          if (mounted) {
              ...
              SnackBar(
                content: const Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text('Account Created! Welcome to Code Lab 3D 🎉',
            ...
            if (mounted) _navigateToDashboard(response.user!.id);
          }
        }
      }
    } catch (e) {
  ...
  Future<void> _navigateToDashboard(String userId) async {
    final userData = await _supabase
        ...
        .single();
    if (mounted) {
      context.go(userData['role'] == 'instructor'
  ...
  void _showForgotPasswordDialog() {
    ...
    final hintColor = isDark ? Colors.white.withValues(alpha: 0.5) : const Color(0xFF0D1B4B).withValues(alpha: 0.4);
              ...
              children: [
                ...
                Row(children: [
                  Container(
                    ...
                    child: Icon(
                      step == 1 ? Icons.lock_reset_outlined : Icons.pin_outlined,
                      color: const Color(0xFF1E90FF), size: 22),
                  ),
                ...
                if (step == 1) ...[
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(fontFamily: 'Poppins', fontSize: 13, color: hintColor),
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          height: 48,
                          decoration: BoxDecoration(
                            color: cancelBg, borderRadius: BorderRadius.circular(12),
                            border: Border.all(color: borderColor)),
                          child: Center(child: Text('Cancel',
                            style: TextStyle(fontFamily: 'Poppins', color: cancelTextColor, fontWeight: FontWeight.w600))),
                        ),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: isSending ? null : () async {
                          ...
                          try {
                            await _supabase.auth.resetPasswordForEmail(
                              email,
                              redirectTo: 'com.psulubao.it.lcms_app://reset-password',
                            );
                            ...
                            if (mounted) {
                              ...
                              SnackBar(
                                content: Row(children: [
                                  ...
                                  Expanded(child: Text('OTP sent to $email 📧',
                        ...
                        child: isSending
                            ...
                            : const Text('Send OTP', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w700)),
                      ),
                    ),
                  ]),
                ],
                ...
                if (step == 2) ...[
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(fontFamily: 'Poppins', fontSize: 13, color: hintColor),
                      floatingLabelStyle: const TextStyle(fontFamily: 'Poppins', fontSize: 12, color: Color(0xFF1E90FF), fontWeight: FontWeight.w600),
                      prefixIcon: Icon(Icons.pin_outlined, color: iconColor, size: 20),
                      filled: true, fillColor: fillColor,
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: isVerifying ? null : () async {
                          ...
                          try {
                            ...
                            if (mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Invalid OTP or expired. Try again.'),
                                backgroundColor: Colors.red, behavior: SnackBarBehavior.floating));
                            }
                          }
                        },
                        child: isVerifying
                            ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
                            : const Text('Verify', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w700, fontSize: 15)),
                      ),
                    ),
                  ]),
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        try {
                          ...
                          if (mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('New OTP sent! Check your email.'),
                              backgroundColor: Colors.blue, behavior: SnackBarBehavior.floating));
                          }
                        } catch (e) { debugPrint('Resend: $e'); }
                      },
                          ...
                          children: [
                            ...
                            _animatedField(
                              ...
                              child: _buildField(
                                ...
                                validator: (v) {
                                  if (!_isSignIn && (v == null || v.isEmpty)) return 'Enter your full name';
                                  return null;
                                },
                              ),
                            ),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: isDark ? const Color(0xFF1E3A6E) : const Color(0xFFDDE3F0)),
                                  ),
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Row(children: [
                                        Icon(Icons.wc_outlined, color: isDark ? Colors.white.withValues(alpha: 0.3) : const Color(0xFF0D1B4B).withValues(alpha: 0.4), size: 20),
                                        const SizedBox(width: 10),
                                        Text('Sex', style: TextStyle(fontFamily: 'Poppins', fontSize: 13, color: isDark ? Colors.white.withValues(alpha: 0.5) : const Color(0xFF0D1B4B).withValues(alpha: 0.4))),
                                      ]),
                            ...
                            _animatedField(
                              ...
                              child: _buildField(
                                ...
                                validator: (v) {
                                  if (!_isSignIn && !_isStudent && (v == null || v.isEmpty)) return 'Enter the faculty secret code';
                                  return null;
                                },
                              ),
                            ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.fingerprint,
                                  color: isDark ? Colors.white.withValues(alpha: 0.7) : const Color(0xFF0D1B4B).withValues(alpha: 0.7), size: 24),
                                const SizedBox(width: 10),
                                Text('Sign in with Biometrics',
                                  style: TextStyle(
                                    fontFamily: 'Poppins', fontSize: 14, fontWeight: FontWeight.w600,
                                    color: isDark ? Colors.white.withValues(alpha: 0.7) : const Color(0xFF0D1B4B).withValues(alpha: 0.7),
                                  ),
                                ),
                              ],
                            ),
  ...
  Widget _animatedField({required bool isVisible, required Widget child}) {
    return AnimatedSize(
      ...
      child: AnimatedOpacity(
        ...
        child: isVisible ? child : const SizedBox(width: double.infinity, height: 0),
      ),
    );
  }
  ...
  Widget _buildTabSwitcher({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isDark ? const Color(0xFF1E3A6E) : const Color(0xFFDDE3F0), width: 1),
      ),
      child: Row(children: [
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(colors: [Color(0xFF1565C0), Color(0xFF1E90FF)], begin: Alignment.centerLeft, end: Alignment.centerRight),
            borderRadius: BorderRadius.circular(32),
            boxShadow: [
              BoxShadow(
          ...
          child: Center(
            child: _isLoading
                ...
                : Text(_isSignIn ? 'Sign In' : 'Sign Up',
                    style: const TextStyle(fontFamily: 'Poppins', fontSize: 17, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 0.5)),
          ),
        ),
      ),
    );
  ...
  Widget _buildGridOverlay(Size size) {
    return Opacity(opacity: 0.04, child: CustomPaint(size: size, painter: _GridPainter()));
  }
