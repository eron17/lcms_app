...
class _StudentDashboardState extends ConsumerState<StudentDashboard>
  ...
  Future<void> _logout() async {
    ...
    // Logging out only ends the session — saved biometric credentials are
    // intentionally left in place so fingerprint sign-in keeps working next
    // time. They're only cleared by the 2-min background timeout / killed-
    // while-backgrounded security paths in app_security_manager.dart.
  ...
  Widget _buildProfilePage() {
    ...
    final isDesktop = MediaQuery.of(context).size.width > 900;
    return SingleChildScrollView(
      padding: EdgeInsets.fromLTRB(20, isDesktop ? 32 : 10, 20, 10),
      physics: const BouncingScrollPhysics(),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
